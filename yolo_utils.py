...
def get_training_data(annotation_path, data_path, input_shape, anchors, status, num_classes, max_boxes=100, load_previous=True):
    """
...
def pre_process_data(annotation_path, data_path, input_shape, anchors, status, num_classes, max_boxes=100, load_previous=True):
    """
    processes the data into standard shape
    :param annotation_path: path_to_image box1,box2,...,boxN with boxX: x_min,y_min,x_max,y_max,class_index
    :param data_path: saver at "/home/minh/stage/train.npz"
